...
select EmployeeID, EmployeeName, ManagerID, DepartmentName, RoleName, group_concat(distinct ProjectName separator ', ') ProjectNames, group_concat(distinct TaskName separator ', ') TaskNames, TotalTasks, child TotalSubordinates
from (
...
group by EmployeeID, EmployeeName, ManagerID, DepartmentName , RoleName, TotalTasks, child
